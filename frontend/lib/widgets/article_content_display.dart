...
class ArticleContentDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.all(20.0), // Increased padding for readability
      child: Center( // Center the constrained content
        child: ConstrainedBox(
          constraints: const BoxConstraints(maxWidth: 700.0), // Limit content width for readability
          child: Column(
